"""
Django settings for room3d project.
...
INSTALLED_APPS = [
    ...
    'gallery_TO_app.apps.GalleryTOAppConfig',
    'contact_app.apps.ContactAppConfig',
    'auth_app.apps.AuthAppConfig',
    'gallery_2D_app.apps.Gallery2DAppConfig',
    'gallery_3D_app.apps.Gallery3DAppConfig',
]
...
WSGI_APPLICATION = 'room3d.wsgi.application'
